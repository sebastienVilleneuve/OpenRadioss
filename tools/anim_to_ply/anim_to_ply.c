...
// g++ -DLINUX -o anim_to_ply.linux64.exe anim_to_ply.c

// To launch conversion :
// anim_to_ply.linux64.exe  animationFile > vtkFile
           ...
           bool text = false)
{
    ...
    if (ret == 0)
    {
        cout << "Error in reading file: reached EOF" << "\n";
    }
...
void readRadiossAnim(char *fileName)
{
    ...
    case FASTMAGI10:
    {
        ...
        for (int ifun = 0; ifun < nbFunc; ifun++)
        {
            ...
            cout << "property float " << fTextA[ifun] << "\n";
        }

        // elements header 
        //cout << "element face " << nbFacets+nbElts3D+nbEltsSPH << "\n";
        cout << "element face " << nbFacets << "\n";
        cout << "property list uchar uint vertex_index "<< "\n";

        for (int iefun = 0; iefun < nbEFunc; iefun++)
        {
            replaceUnderscore(fTextA[iefun+nbFunc]);
            cout << "property float " << fTextA[iefun+nbFunc] << "\n";
        }
        /*for (int iefun = 0; iefun < nbEFunc3D; iefun++)
        {
            replaceUnderscore(fTextA[iefun]);
            cout << "property float " << fText3DA[iefun] << "\n";
        }*/
        ...
        // elements 
        //if (nbFacets+nbElts3D+nbEltsSPH)
        if (nbFacets)
        {
