...
/*=================================================================*/
{
    ...
    void c_h3d_create_quad_eroded_(int *cpt_data, char *name, int *size)
    {
        char *cname;
        int cname_len;
        int i;
    ...
    void _FCALL C_H3D_CREATE_QUAD_ERODED(int *cpt_data, char *name, int *size)
    {
        c_h3d_create_quad_eroded_(cpt_data, name, size);
    }

    void c_h3d_create_quad_eroded__(int *cpt_data, char *name, int *size)
    {
        c_h3d_create_quad_eroded_(cpt_data, name, size);
    }

    void c_h3d_create_quad_eroded(int *cpt_data, char *name, int *size)
    {
        c_h3d_create_quad_eroded_(cpt_data, name, size);
    }
}
