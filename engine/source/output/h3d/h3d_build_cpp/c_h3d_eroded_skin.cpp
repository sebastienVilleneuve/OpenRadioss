...
/*=================================================================*/
{
    ...
    void c_h3d_create_skin_eroded_(int *cpt_data, char *name, int *size)
    {
        char *cname, *cname1;
    ...
    void _FCALL C_H3D_CREATE_SKIN_ERODED(int *cpt_data, char *name, int *size)
    {
        c_h3d_create_skin_eroded_(cpt_data, name, size);
    }

    void c_h3d_create_skin_eroded__(int *cpt_data, char *name, int *size)
    {
        c_h3d_create_skin_eroded_(cpt_data, name, size);
    }

    void c_h3d_create_skin_eroded(int *cpt_data, char *name, int *size)
    {
        c_h3d_create_skin_eroded_(cpt_data, name, size);
    }
}
