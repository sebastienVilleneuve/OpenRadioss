                                   ...
                                   int *COMPID_RBODIES, int *COMPID_RBE2S, int *COMPID_RBE3S)
     {
          ...
          try
          {
               ...
               for (int isu = 0; isu < *NSUBS; isu++)
               {
                    ...
                    if (level_max < SUB_LEVEL[isu])
                         level_max = SUB_LEVEL[isu];
                    if (id_max < SUB_ID[isu])
                         id_max = SUB_ID[isu];
               }
               ...
               for (i = 0; i < *NPART; i++)
               {
                    ...
                    if (H3D_PART[i] == 1)
                    {
                         ...
                         if (strlen(name_part) == 0)
                              sprintf(name_part, "no part name");
