...
/*=================================================================*/
{
    ...
    void c_h3d_create_sph_eroded_(int *cpt_data, char *name, int *size)
    {
        char *cname;
        int cname_len;
        int i;
    ...
    void _FCALL C_H3D_CREATE_SPH_ERODED(int *cpt_data, char *name, int *size)
    {
        c_h3d_create_sph_eroded_(cpt_data, name, size);
    }

    void c_h3d_create_sph_eroded__(int *cpt_data, char *name, int *size)
    {
        c_h3d_create_sph_eroded_(cpt_data, name, size);
    }

    void c_h3d_create_sph_eroded(int *cpt_data, char *name, int *size)
    {
        c_h3d_create_sph_eroded_(cpt_data, name, size);
    }
}
