...
/*=================================================================*/
{
  ...
  void c_h3d_create_oned_eroded_(int *cpt_data, char *name, int *size)
  {
    char *cname;
  ...
  void _FCALL C_H3D_CREATE_ONED_ERODED(int *cpt_data, char *name, int *size)
  {
    c_h3d_create_oned_eroded_(cpt_data, name, size);
  }

  void c_h3d_create_oned_eroded__(int *cpt_data, char *name, int *size)
  {
    c_h3d_create_oned_eroded_(cpt_data, name, size);
  }

  void c_h3d_create_oned_eroded(int *cpt_data, char *name, int *size)
  {
    c_h3d_create_oned_eroded_(cpt_data, name, size);
  }
}
