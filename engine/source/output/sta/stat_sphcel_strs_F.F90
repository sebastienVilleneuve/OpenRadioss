...
!Copyright>        commercial version may interest you: https://www.altair.com/radioss/.
      module stat_sphcel_strs_f_mod
        contains
! ======================================================================================================================
!                                                   PROCEDURES
! ======================================================================================================================
!! \sphcel element write strs_f in state file ( stress , energy , rho, slen, epsp )
        subroutine stat_sphcel_strs_f(numsph    ,nisp       ,ngroup     ,nparg         ,sizloc          , npart , &
                                    sizp0     ,nspmd      ,stat_numelsph ,stat_numelsph_g ,  nspbuf , numnod ,&
                                    kxsp       ,ipartsph   ,ipart_state   ,stat_indxsph    ,  &
                                    iparg     ,elbuf_tab  ,wa         ,wap0          ,spbuf, itab)
! ----------------------------------------------------------------------------------------------------------------------
!                                                   Modules
! ----------------------------------------------------------------------------------------------------------------------
...
! ----------------------------------------------------------------------------------------------------------------------
          ...
          integer,                                   intent(in) :: nspbuf        !< size for array definition
          ...
          my_real,                                   intent(in) :: spbuf(nspbuf,numsph) 
...
!--------------------------------------
                    if (iprt /= iprt0) then
                      ...
                      write(iugeo,'(a)')'/INISPHCEL/STRS_F'
                      write(iugeo,'(a)')&
                                 '#----------------------------------------------------------'
...
!--------------------------------------
          ...
          return
! ----------------------------------------------------------------------------------------------------------------------
        end subroutine stat_sphcel_strs_f
      end module stat_sphcel_strs_f_mod
