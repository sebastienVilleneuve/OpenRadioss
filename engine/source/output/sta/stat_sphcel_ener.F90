...
!Copyright>        commercial version may interest you: https://www.altair.com/radioss/.
      module stat_sphcel_ener_mod
        contains
! ======================================================================================================================
!                                                   PROCEDURES
! ======================================================================================================================
!! \sphcel element write ener in state file 
        subroutine stat_sphcel_ener(numsph    ,nisp       ,ngroup     ,nparg         ,sizloc          , npart , &
              ...
              if (ity == 51) then
                ...
                do i=lft,llt
                  ...
                  if (ipart_state(iprt) /= 0) then
                    ...
                    wa(jj) = kxsp(nisp,n)
                    jj = jj + 1
                    wa(jj) = elbuf_tab(ng)%gbuf%eint(i)
                    !---
                    ie=ie+1
...
!--------------------------------------
                    if (iprt /= iprt0) then
                      ...
                      write(iugeo,'(a)')'/INISPHCEL/ENER'
                      write(iugeo,'(a)')&
                                 '#----------------------------------------------------------'
                      write(iugeo,'(a)')'#SPHCEL_ID'
                      write(iugeo,'(a)')'#format:(1pe20.13) #(ein(i),i=sphcel_id)'
                      write(iugeo,'(a)')&
                                 '#----------------------------------------------------------'
                      !
                      iprt0=iprt
...
!--------------------------------------
          ...
          return
! ----------------------------------------------------------------------------------------------------------------------
        end subroutine stat_sphcel_ener
      end module stat_sphcel_ener_mod
