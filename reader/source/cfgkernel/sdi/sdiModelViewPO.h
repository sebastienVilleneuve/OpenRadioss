...
public:
                                ...
                                const unsigned int        id = 0)
    {
        ...
        printf ("Created entity of type %s with id=%d\n", keyword.c_str(), validId);
        printf ("p_currentIncludeId=%d\n", p_currentIncludeId);
                                 ...
                                 const unsigned int       id = 0)
    {
        ...
        printf("DEBUG: p_currentIncludeId=%d, p_previousIncludeId=%d\n", 
               p_currentIncludeId, p_previousIncludeId);
        
        int idIndex, xIndex, yIndex, zIndex, arraySize = 0;
        if(p_preobjects[HCDI_OBJ_TYPE_NODES].size() > 0 && p_previousIncludeId == p_currentIncludeId)
        {
        ...
        {
            printf("DEBUG: Creating new node preobject p_currentIncludeId=%d\n", p_currentIncludeId);
            pObj = HCDI_GetPreObjectHandle("", keyword.c_str(), "", (int) p_currentIncludeId, 0);
            pObj->SetFileIndex(p_currentIncludeId);
            p_previousIncludeId = p_currentIncludeId;
