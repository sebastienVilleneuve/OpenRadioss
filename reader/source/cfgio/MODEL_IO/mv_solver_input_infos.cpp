...
static int GetHMNAMEEntityNameSize(obj_type_e& etype, const char* line, int* id_format)
{
    ...
    else if (!strncmp(line, "COMP", 4)) { etype = HCDI_OBJ_TYPE_COMPS; return 4; }
    ...
    else if (!strncmp(line, "PROP", 4)) { etype = HCDI_OBJ_TYPE_PROPS; return 4; }
    ...
    else if (!strncmp(line, "MAT", 3)) { etype = HCDI_OBJ_TYPE_MATS; return 3; }
