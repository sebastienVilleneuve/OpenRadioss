...
void sdiD2R::ConvertInclude::ConvertEntities()
{
    ...
    while (selInclude.Next())
    {
        if(selInclude->GetKeyword() == "*INCLUDE_TRANSFORM")
        {
            ...
            printf("!!!!!!!!!!!!!!!!!!!!!!!!     Convert INCLUDE_TRANSFORM id=%d name=%s\n", id, name.c_str());
            ...
            if(p_useSubmodelOffsets)
            {
                ...
                printf("!!!!!!!!!!!!! Convert INCLUDE_TRANSFORM id=%d defineTransformEnt=%d\n", id, defineTransformEnt);
            ...
            printf("!!!!!!!!!!!!!!!!! isValid=%d\n", defineTransformHandle.IsValid());
            if(defineTransformHandle.IsValid())
            {
                printf("TRANID %d\n", defineTransformHandle.GetId(p_lsdynaModel));
            }
            ...
            printf("Convert INCLUDE_TRANSFORM id=%d TRANID=%d\n", id, TRANID);
            if(0 < TRANID)
            {
